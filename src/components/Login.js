...
const Login = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:5000/auth/login', userData, { withCredentials: true })
            .then((res) => {
                    ...
                    <div className='login_content'>
                        ...
                        <form action='/' method='post' onSubmit={handleSubmit} className='register_form' id='register_form'>
                            ...
                            <div className='social_icons_list'>
                                <div className='google' onClick={google}><FaGoogle /></div>
                            </div>
                    </div>
                </div>
            </section>
