            ...
            <div id='main-outer'>
                ...
                <div className='outer-FAQ'>
                    ...
                    <div className='FAQ'>
                        <h1>FAQs</h1>
                        <div className='acc'>
                            <Collapsible trigger="1. How is ROTARY ENGLISH MEDIUM SCHOOL different from other international schools around?" transitionTime={200} >
                        ...
                        <div className='acc'>
                            <Collapsible trigger="2. Is there a school uniform?" transitionTime={200} >
                                <h3>Ans- Yes, we have school uniforms for students from Grade 1 to Grade 12.</h3>
                            </Collapsible>
                        </div>
                        <div className='acc'>
                            <Collapsible trigger="3. Are your teachers working in the school well qualified?" transitionTime={200} >
                                <h3> "Ans- The teaching staff is highly qualified in their respective fields.</h3>
                            </Collapsible>
                        </div>
                        <div className='acc'>
                            <Collapsible trigger="4. What is the age criterion for admissions?" transitionTime={200} >
                        ...
                        <div className='acc'>
                            <Collapsible trigger="5. What is the teacher student ratio in the school?" transitionTime={200} >
